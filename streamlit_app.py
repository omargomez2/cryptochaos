...
st.image(http_chen, caption= 'Rossler Attractor', width=200)
...
st.image(http_chen, caption= 'Lorenz Attractor', width=200)
...
st.image(http_chen, caption= 'Chen Attractor', width=200)
...
st.image(http_chen, caption= 'Sprott Attractor', width=200)
