...
st.image(http_chen, caption= 'Rossler Attractor', width=300)
...
st.image(http_chen, caption= 'Lorenz Attractor', width=300)
...
st.image(http_chen, caption= 'Sprott Attractor', width=300)
